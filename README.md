...
Содержит метод format_info(), который возвращает строку с информацией о продукте. Этот метод может использоваться в любом классе, который наследует от ProductMixin.
