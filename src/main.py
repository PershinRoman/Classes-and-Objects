...
class Categoryiter:
    ...
    def middle_price(self) -> float:
        ...
        Если товаров нет (деление на ноль), возвращает 0.
        """
        try:
            # Если товаров нет, длина списка равна нулю, что вызовет ZeroDivisionError.
            average = sum(product.price for product in self.products) / len(self.products)
            return average
...
#     print(product3.quantity)
#
#     category1 = Categoryiter("Смартфоны",
#                          "Смартфоны, как средство не только коммуникации, но и получения дополнительных функций для удобства жизни",
#                          [product1, product2, product3])
#
#     print(category1.name == "Смартфоны")
...
#
#     product4 = Product("55\" QLED 4K", "Фоновая подсветка", 123000.0, 7)
#     category2 = Categoryiter("Телевизоры",
#                          "Современный телевизор, который позволяет наслаждаться просмотром, станет вашим другом и помощником",
#                          [product4])
#
#     print(category2.name)
...
if __name__ == '__main__':
    ...
    category1 = Categoryiter("Смартфоны", "Категория смартфонов", [product1, product2, product3])

    print(category1.middle_price())

    category_empty = Categoryiter("Пустая категория", "Категория без продуктов", [])
